...
! config
!
  integer, parameter :: species_max = 10, species_electrons = 1, species_length = 6, reactions_max = 19, reactions_length = 25
...
!
  ...
  integer, parameter, private               :: bolsig_species_max = 2, bolsig_species_length = 2, bolsig_rates_max = 2 
...
!
  ...
  /"E     ","N2    ","O2    ","O4^+  ","O2^+  ","N2^+  ","N4^+  ","O2^+N2","O     ","O2^-  "/
  data reaction_sign(1:reactions_max) &
  /"bolsig:N2->N2^+          ","bolsig:O2->O2^+          ","E+O2+O2=>O2^-+O2         ","N2^++N2+O2=>N4^++O2      ",&
   "N2^++N2+N2=>N4^++N2      ","N4^++O2=>O2^++N2+N2      ","N2^++O2=>O2^++N2         ","O2^++N2+N2=>O2^+N2+N2    ",&
   "O2^+N2+N2=>O2^++N2+N2    ","O2^+N2+O2=>O4^++N2       ","O2^++O2+O2=>O4^++O2      ","O2^++O2+N2=>O4^++N2      ",&
   "E+O4^+=>O2+O2            ","E+O2^+=>O+O              ","O2^-+O4^+=>O2+O2+O2      ","O2^-+O4^++O2=>O2+O2+O2+O2",&
   "O2^-+O4^++N2=>O2+O2+O2+N2","O2^-+O2^++O2=>O2+O2+O2   ","O2^-+O2^++N2=>O2+O2+N2   "/
...
300 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file <" &
    ...
    close(ifile_unit)
311 format(291x,10(1x,i9))
312 format(A2,1x,A25,1x,10(1x,A9))
313 format(i2,1x,A25,1x,10(1x,1pd9.2))
  endif
  return
...
100 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
    ...
    do i = 1, species_max
      write(ifile_unit,"(19(i3))",err=200) int(mrtm(i,:))
    enddo
    lerror = .false.
200 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
...
400 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
    ...
    write(ifile_unit,"(1x,A12,19(111x,i2.2))",err=500) "Time_s", ( i, i = 1, reactions_max )
    lerror = .false.
500 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
  ...
  if( ( time - densav(0,1) ) >= rtol .or. lfirst ) then
    ...
    if( rtol > qtplaskin_rtol .or. lfirst ) then
      ...
      write(ifile_unit,"(20(1pe13.4))") densav(0,2), rrt_loc(:)
      close(ifile_unit)
      densav(:,1) = densav(:,2)
    endif
  endif
...
subroutine ZDPlasKin_reac_source_matrix(reac_rate_local,reac_source_local)
  ...
  reac_source_local(10,03) = + reac_rate_local(03) 
  reac_source_local(02,04) = - reac_rate_local(04) 
  ...
  reac_source_local(02,06) = + reac_rate_local(06) * 2.d0
  ...
  reac_source_local(02,09) = + reac_rate_local(09) 
  reac_source_local(05,09) = + reac_rate_local(09) 
  ...
  reac_source_local(04,10) = + reac_rate_local(10) 
  ...
  reac_source_local(01,14) = - reac_rate_local(14) 
  reac_source_local(05,14) = - reac_rate_local(14) 
  reac_source_local(09,14) = + reac_rate_local(14) * 2.d0
  reac_source_local(03,15) = + reac_rate_local(15) * 3.d0
  reac_source_local(04,15) = - reac_rate_local(15) 
  reac_source_local(10,15) = - reac_rate_local(15) 
  reac_source_local(03,16) = + reac_rate_local(16) * 3.d0
  reac_source_local(04,16) = - reac_rate_local(16) 
  reac_source_local(10,16) = - reac_rate_local(16) 
  reac_source_local(03,17) = + reac_rate_local(17) * 3.d0
  reac_source_local(04,17) = - reac_rate_local(17) 
  reac_source_local(10,17) = - reac_rate_local(17) 
  reac_source_local(03,18) = + reac_rate_local(18) * 2.d0
  reac_source_local(05,18) = - reac_rate_local(18) 
  reac_source_local(10,18) = - reac_rate_local(18) 
  reac_source_local(03,19) = + reac_rate_local(19) * 2.d0
...
subroutine ZDPlasKin_fex(neq,t,y,ydot)
  ...
  rrt(04) = rrt(04) * density(02) * density(03) * density(06) 
  rrt(05) = rrt(05) * density(02)**2 * density(06) 
  rrt(06) = rrt(06) * density(03) * density(07) 
  rrt(07) = rrt(07) * density(03) * density(06) 
  rrt(08) = rrt(08) * density(02)**2 * density(05) 
  rrt(09) = rrt(09) * density(02) * density(08) 
  rrt(10) = rrt(10) * density(03) * density(08) 
  rrt(11) = rrt(11) * density(03)**2 * density(05) 
  rrt(12) = rrt(12) * density(02) * density(03) * density(05) 
  rrt(13) = rrt(13) * density(01) * density(04) 
  rrt(14) = rrt(14) * density(01) * density(05) 
  rrt(15) = rrt(15) * density(04) * density(10) 
  rrt(16) = rrt(16) * density(03) * density(04) * density(10) 
  rrt(17) = rrt(17) * density(02) * density(04) * density(10) 
  rrt(18) = rrt(18) * density(03) * density(05) * density(10) 
  rrt(19) = rrt(19) * density(02) * density(05) * density(10) 
  ydot(01) = +rrt(01)+rrt(02)-rrt(03)-rrt(13)-rrt(14) 
  ydot(02) = -rrt(01)-rrt(04)-rrt(05)+ 2.d0 * rrt(06)+rrt(07)-rrt(08)+rrt(09)+rrt(10) 
  ydot(03) = -rrt(02)-rrt(03)-rrt(06)-rrt(07)-rrt(10)-rrt(11)-rrt(12)+ 2.d0 * rrt(13)+ 3.d0 * rrt(15)+ 3.d0 * rrt(16)&
             + 3.d0 * rrt(17)+ 2.d0 * rrt(18)+ 2.d0 * rrt(19) 
  ydot(04) = +rrt(10)+rrt(11)+rrt(12)-rrt(13)-rrt(15)-rrt(16)-rrt(17) 
  ydot(05) = +rrt(02)+rrt(06)+rrt(07)-rrt(08)+rrt(09)-rrt(11)-rrt(12)-rrt(14)-rrt(18)-rrt(19) 
  ydot(06) = +rrt(01)-rrt(04)-rrt(05)-rrt(07) 
  ydot(07) = +rrt(04)+rrt(05)-rrt(06) 
  ydot(08) = +rrt(08)-rrt(09)-rrt(10) 
  ydot(09) = + 2.d0 * rrt(14) 
  ydot(10) = +rrt(03)-rrt(15)-rrt(16)-rrt(17)-rrt(18)-rrt(19) 
...
subroutine ZDPlasKin_jex(neq,t,y,ml,mu,pd,nrpd)
  ...
  pd(06,01) = pd(06,01) + rrt(01) * density(02) 
  pd(06,02) = pd(06,02) + rrt(01) * density(01) 
  ...
  pd(10,01) = pd(10,01) + rrt(03) * density(03)**2 
  pd(10,03) = pd(10,03) + rrt(03) * density(01) * density(03) * 2.0d0
  pd(02,02) = pd(02,02) - rrt(04) * density(03) * density(06) 
  pd(02,03) = pd(02,03) - rrt(04) * density(02) * density(06) 
  pd(02,06) = pd(02,06) - rrt(04) * density(02) * density(03) 
  pd(06,02) = pd(06,02) - rrt(04) * density(03) * density(06) 
  pd(06,03) = pd(06,03) - rrt(04) * density(02) * density(06) 
  pd(06,06) = pd(06,06) - rrt(04) * density(02) * density(03) 
  pd(07,02) = pd(07,02) + rrt(04) * density(03) * density(06) 
  pd(07,03) = pd(07,03) + rrt(04) * density(02) * density(06) 
  pd(07,06) = pd(07,06) + rrt(04) * density(02) * density(03) 
  pd(02,02) = pd(02,02) - rrt(05) * density(02) * density(06) * 2.0d0
  pd(02,06) = pd(02,06) - rrt(05) * density(02)**2 
  pd(06,02) = pd(06,02) - rrt(05) * density(02) * density(06) * 2.0d0
  pd(06,06) = pd(06,06) - rrt(05) * density(02)**2 
  pd(07,02) = pd(07,02) + rrt(05) * density(02) * density(06) * 2.0d0
  pd(07,06) = pd(07,06) + rrt(05) * density(02)**2 
  pd(02,03) = pd(02,03) + rrt(06) * density(07) * 2.0d0
  pd(02,07) = pd(02,07) + rrt(06) * density(03) * 2.0d0
  pd(03,03) = pd(03,03) - rrt(06) * density(07) 
  pd(03,07) = pd(03,07) - rrt(06) * density(03) 
  pd(05,03) = pd(05,03) + rrt(06) * density(07) 
  pd(05,07) = pd(05,07) + rrt(06) * density(03) 
  pd(07,03) = pd(07,03) - rrt(06) * density(07) 
  pd(07,07) = pd(07,07) - rrt(06) * density(03) 
  pd(02,03) = pd(02,03) + rrt(07) * density(06) 
  pd(02,06) = pd(02,06) + rrt(07) * density(03) 
  pd(03,03) = pd(03,03) - rrt(07) * density(06) 
  pd(03,06) = pd(03,06) - rrt(07) * density(03) 
  pd(05,03) = pd(05,03) + rrt(07) * density(06) 
  pd(05,06) = pd(05,06) + rrt(07) * density(03) 
  pd(06,03) = pd(06,03) - rrt(07) * density(06) 
  pd(06,06) = pd(06,06) - rrt(07) * density(03) 
  pd(02,02) = pd(02,02) - rrt(08) * density(02) * density(05) * 2.0d0
  pd(02,05) = pd(02,05) - rrt(08) * density(02)**2 
  pd(05,02) = pd(05,02) - rrt(08) * density(02) * density(05) * 2.0d0
  pd(05,05) = pd(05,05) - rrt(08) * density(02)**2 
  pd(08,02) = pd(08,02) + rrt(08) * density(02) * density(05) * 2.0d0
  pd(08,05) = pd(08,05) + rrt(08) * density(02)**2 
  pd(02,02) = pd(02,02) + rrt(09) * density(08) 
  pd(02,08) = pd(02,08) + rrt(09) * density(02) 
  pd(05,02) = pd(05,02) + rrt(09) * density(08) 
  pd(05,08) = pd(05,08) + rrt(09) * density(02) 
  pd(08,02) = pd(08,02) - rrt(09) * density(08) 
  pd(08,08) = pd(08,08) - rrt(09) * density(02) 
  pd(02,03) = pd(02,03) + rrt(10) * density(08) 
  pd(02,08) = pd(02,08) + rrt(10) * density(03) 
  pd(03,03) = pd(03,03) - rrt(10) * density(08) 
  pd(03,08) = pd(03,08) - rrt(10) * density(03) 
  pd(04,03) = pd(04,03) + rrt(10) * density(08) 
  pd(04,08) = pd(04,08) + rrt(10) * density(03) 
  pd(08,03) = pd(08,03) - rrt(10) * density(08) 
  pd(08,08) = pd(08,08) - rrt(10) * density(03) 
  pd(03,03) = pd(03,03) - rrt(11) * density(03) * density(05) * 2.0d0
  pd(03,05) = pd(03,05) - rrt(11) * density(03)**2 
  pd(04,03) = pd(04,03) + rrt(11) * density(03) * density(05) * 2.0d0
  pd(04,05) = pd(04,05) + rrt(11) * density(03)**2 
  pd(05,03) = pd(05,03) - rrt(11) * density(03) * density(05) * 2.0d0
  pd(05,05) = pd(05,05) - rrt(11) * density(03)**2 
  pd(03,02) = pd(03,02) - rrt(12) * density(03) * density(05) 
  pd(03,03) = pd(03,03) - rrt(12) * density(02) * density(05) 
  pd(03,05) = pd(03,05) - rrt(12) * density(02) * density(03) 
  pd(04,02) = pd(04,02) + rrt(12) * density(03) * density(05) 
  pd(04,03) = pd(04,03) + rrt(12) * density(02) * density(05) 
  pd(04,05) = pd(04,05) + rrt(12) * density(02) * density(03) 
  pd(05,02) = pd(05,02) - rrt(12) * density(03) * density(05) 
  pd(05,03) = pd(05,03) - rrt(12) * density(02) * density(05) 
  pd(05,05) = pd(05,05) - rrt(12) * density(02) * density(03) 
  pd(01,01) = pd(01,01) - rrt(13) * density(04) 
  pd(01,04) = pd(01,04) - rrt(13) * density(01) 
  pd(03,01) = pd(03,01) + rrt(13) * density(04) * 2.0d0
  pd(03,04) = pd(03,04) + rrt(13) * density(01) * 2.0d0
  pd(04,01) = pd(04,01) - rrt(13) * density(04) 
  pd(04,04) = pd(04,04) - rrt(13) * density(01) 
  pd(01,01) = pd(01,01) - rrt(14) * density(05) 
  pd(01,05) = pd(01,05) - rrt(14) * density(01) 
  pd(05,01) = pd(05,01) - rrt(14) * density(05) 
  pd(05,05) = pd(05,05) - rrt(14) * density(01) 
  pd(09,01) = pd(09,01) + rrt(14) * density(05) * 2.0d0
  pd(09,05) = pd(09,05) + rrt(14) * density(01) * 2.0d0
  pd(03,04) = pd(03,04) + rrt(15) * density(10) * 3.0d0
  pd(03,10) = pd(03,10) + rrt(15) * density(04) * 3.0d0
  pd(04,04) = pd(04,04) - rrt(15) * density(10) 
  pd(04,10) = pd(04,10) - rrt(15) * density(04) 
  pd(10,04) = pd(10,04) - rrt(15) * density(10) 
  pd(10,10) = pd(10,10) - rrt(15) * density(04) 
  pd(03,03) = pd(03,03) + rrt(16) * density(04) * density(10) * 3.0d0
  pd(03,04) = pd(03,04) + rrt(16) * density(03) * density(10) * 3.0d0
  pd(03,10) = pd(03,10) + rrt(16) * density(03) * density(04) * 3.0d0
  pd(04,03) = pd(04,03) - rrt(16) * density(04) * density(10) 
  pd(04,04) = pd(04,04) - rrt(16) * density(03) * density(10) 
  pd(04,10) = pd(04,10) - rrt(16) * density(03) * density(04) 
  pd(10,03) = pd(10,03) - rrt(16) * density(04) * density(10) 
  pd(10,04) = pd(10,04) - rrt(16) * density(03) * density(10) 
  pd(10,10) = pd(10,10) - rrt(16) * density(03) * density(04) 
  pd(03,02) = pd(03,02) + rrt(17) * density(04) * density(10) * 3.0d0
  pd(03,04) = pd(03,04) + rrt(17) * density(02) * density(10) * 3.0d0
  pd(03,10) = pd(03,10) + rrt(17) * density(02) * density(04) * 3.0d0
  pd(04,02) = pd(04,02) - rrt(17) * density(04) * density(10) 
  pd(04,04) = pd(04,04) - rrt(17) * density(02) * density(10) 
  pd(04,10) = pd(04,10) - rrt(17) * density(02) * density(04) 
  pd(10,02) = pd(10,02) - rrt(17) * density(04) * density(10) 
  pd(10,04) = pd(10,04) - rrt(17) * density(02) * density(10) 
  pd(10,10) = pd(10,10) - rrt(17) * density(02) * density(04) 
  pd(03,03) = pd(03,03) + rrt(18) * density(05) * density(10) * 2.0d0
  pd(03,05) = pd(03,05) + rrt(18) * density(03) * density(10) * 2.0d0
  pd(03,10) = pd(03,10) + rrt(18) * density(03) * density(05) * 2.0d0
  pd(05,03) = pd(05,03) - rrt(18) * density(05) * density(10) 
  pd(05,05) = pd(05,05) - rrt(18) * density(03) * density(10) 
  pd(05,10) = pd(05,10) - rrt(18) * density(03) * density(05) 
  pd(10,03) = pd(10,03) - rrt(18) * density(05) * density(10) 
  pd(10,05) = pd(10,05) - rrt(18) * density(03) * density(10) 
  pd(10,10) = pd(10,10) - rrt(18) * density(03) * density(05) 
  pd(03,02) = pd(03,02) + rrt(19) * density(05) * density(10) * 2.0d0
  pd(03,05) = pd(03,05) + rrt(19) * density(02) * density(10) * 2.0d0
  pd(03,10) = pd(03,10) + rrt(19) * density(02) * density(05) * 2.0d0
  pd(05,02) = pd(05,02) - rrt(19) * density(05) * density(10) 
  pd(05,05) = pd(05,05) - rrt(19) * density(02) * density(10) 
  pd(05,10) = pd(05,10) - rrt(19) * density(02) * density(05) 
  pd(10,02) = pd(10,02) - rrt(19) * density(05) * density(10) 
  pd(10,05) = pd(10,05) - rrt(19) * density(02) * density(10) 
  pd(10,10) = pd(10,10) - rrt(19) * density(02) * density(05) 
...
subroutine ZDPlasKin_reac_rates(Time)
  ...
  rrt(11) = 2.4D-30
  rrt(12) = 2.4D-30
  rrt(13) = 1.4D-6*(300./TE)**0.5D0
  rrt(14) = 2.0D-7*(300./TE)**0.5D0
  rrt(15) = 1.0D-7
  rrt(16) = 2.0D-25
  rrt(17) = 2.0D-25
  rrt(18) = 2.0D-25
