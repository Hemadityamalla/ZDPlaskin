program pulse_air
  ...
  double precision, parameter :: pulse_amplitude = 120.0d0 !Pulse amplitude in Td
  double precision :: e_field
  double precision :: time, dt, t_final = 1000.0e-9

  double precision :: e_density = 1.0d14 !starting electron density in cm-3
