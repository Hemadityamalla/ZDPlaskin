...
!
  ...
  double precision :: field_amplitude    = 2d+6! Applied field in V/m
  double precision :: SI_to_Townsend = 1.0d21
  double precision :: density_ini_elec = 1.0d13     ! initial electron density, cm-3
  double precision            :: time  = 0.0d0, time_end = 2.0d-8, dtime = 1.0d-10! times, s
...
contains
        subroutine get_field(field_val, t)
                ...
                double precision :: trise = 4.0d-8
                double precision :: tfall = 4.0d-8
                double precision :: tinter = 1.0d-6
                double precision :: tconst = 2.0d-7
                if (t <= (trise)) then
